...
contract ERC721 is Ownable, ERC165, IERC721, IERC721Metadata {
    ...
    function updateNameAndSymbol(string memory name_, string memory symbol_) public virtual onlyOwner {
        _name = name_;
        _symbol = symbol_;
    }
...
contract Tatum721GeneralUpdateableName is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, AccessControl, ERC721Burnable {
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");

    bool _publicMint;
    constructor(string memory name_, string memory symbol_, bool publicMint, address minter)
